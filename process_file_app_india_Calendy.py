...
def preprocess_calendly(filepath, country_name="India"):
    ...
    column_mapping = {
        ...
        "Response 1": "Profile",
        "Response 2": "salary",
        "Response 3": "Notice period/ Availability to join",
        "Response 5": "position",
        "Response 6": "Source",
        "Response 7": "phone",
...
csv_mapping = {
    ...
    'declaration': ['notice period/ availability to join', 'declaration'],
...
def process_L_N_C(india_dfs_calendly, india_dfs_L_N):
    ...
    merged_df["notice_period"] = merged_df["declaration"]
    
    # profile is same as profile_url: duplicate that column
    merged_df["profile"] = merged_df["profile_url"]
    ...
    final_order = [
        ...
        "annual_salary", "notice_period", "source", "profile_url",
    ...
    # output_file = "merged_india_data.csv"
    # merged_df.to_csv(output_file, index=False)
    # print(f"Merged data saved to {output_file}")
    
    # # For debugging: display the first few rows of the merged DataFrame
